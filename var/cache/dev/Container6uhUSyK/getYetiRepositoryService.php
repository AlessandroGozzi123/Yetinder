 ...
 */
class getYetiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\YetiRepository' shared autowired service.
     *
     * @return \App\Repository\YetiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'YetiRepository.php';

        return $container->privates['App\\Repository\\YetiRepository'] = new \App\Repository\YetiRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
